...
const MyBanks: React.FC = () => {
  ...
  return (
    <div>
      {!isAuthed && <h1>You need to sign in!</h1>}
      {isAuthed && (
        <div className="album py-5">
          <div className="add-b">
            <div
              onClick={() => setModalAddActive(true)}
              className="add-b-d btn btn-success btn-gm"
            >
              Add New Bank
            </div>
          </div>
                        ...
                        <div className="card-body">
                          <div className="mb-5px">
                            <p
                              ...
                              className="db text-center card-text"
                            >
                              Delete
                            </p>
                          </div>
                          ...
                          <div>
                            <div
                              ...
                              className="btn btn-warning btn-gm"
                            >
                              Edit Info
                            </div>
                          </div>
